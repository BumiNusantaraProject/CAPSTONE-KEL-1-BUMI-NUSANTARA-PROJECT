...
public class LoginAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html><span style='letter-spacing:12px;'>Senang bertemu<br>dengan admin!</span></html>");
        jPanel1.add(jLabel2);
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(30, 210, 32, 19);
        ...
        btnKembali.setBounds(10, 20, 103, 26);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (user != null) {
            if (user.getRole().equalsIgnoreCase("admin")) {
                ...
                this.dispose();
                new AdminHomeMenu().setVisible(true);
            } else {
